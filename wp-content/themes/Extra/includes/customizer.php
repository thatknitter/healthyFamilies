...
function extra_et_print_font_style_css_value( $setting_name, $property, $unformatted_value ) {
	if ( empty( $unformatted_value ) ) {
		...
		$formatted_value = et_print_font_style( $unformatted_value );
	}
	return $formatted_value;
}
	...
	foreach ( $prefixes as $prefix ) {
		...
		$formatted_value .= sprintf('
			@media only screen and (min-width: 768px) {
				...
				%4$s.header.left-right #et-navigation > ul > li > a {
...
function extra_customize_controls_enqueue_scripts() {
	...
	wp_localize_script( 'extra-customizer-controls-js', 'extra_customizer_control_params', array(
		'footer_sidebar_names' => array(
			'column-1' => array(
				__( 'Footer Sidebar', 'extra' ),
				__( 'Inactive Footer Sidebar', 'extra' ),
				__( 'Inactive Footer Sidebar', 'extra' ),
				__( 'Inactive Footer Sidebar', 'extra' ),
			),
			'column-2' => array(
			...
			'column-3' => array(
				__( 'Footer Sidebar Left', 'extra' ),
				__( 'Footer Sidebar Middle', 'extra' ),
				__( 'Inactive Footer Sidebar', 'extra' ),
				__( 'Footer Sidebar Right', 'extra' ),
			),
			'column-4' => array(
			...
			if ( $selector == $setting_options['value_bind']['selector'] ) {
				...
				if ( '_value_bind_to_value' == $class ) {
					if ( !empty( $setting_options['value_bind']['format'] ) ) {
						$class = str_ireplace( '%value%', $value, $setting_options['value_bind']['format'] );
					} else {
						$class = $value;
					}
				}
...
function extra_customizer_register_general_layout_settings() {
	return array(
		'boxed_layout'  => array(
			'label'      => __( 'Enable Boxed Layout', 'extra' ),
			'type'       => 'checkbox',
			'value_bind' => array(
				'style'    => 'class_toggle',
				'selector' => 'body',
		...
		'content_width' => array(
			'label'       => __( 'Website Content Width', 'extra' ),
			'type'        => 'range',
		...
		'gutter_width'  => array(
			'label'       => __( 'Website Gutter Width', 'extra' ),
			'type'        => 'range',
			'default'     => '3',
			'input_attrs' => array(
				'min'  => 1,
...
function extra_customizer_register_general_typography_settings() {
	return array(
		...
		'body_line_height'           => array(
			'label'       => __( 'Body Line Height', 'extra' ),
			'type'        => 'range',
			'default'     => '1.7',
			'input_attrs' => array(
				'min'  => 0.8,
		...
		'body_heading_font_style'    => array(
			'label'      => __( 'Heading Font Style', 'extra' ),
			'type'       => 'dropdown-font-styles',
			'value_bind' => array(
				'style'                    => 'dynamic_selectors_value_format_callback',
				'value_format_callback'    => 'extra_et_print_font_style_css_value',
		...
		'body_link_color'            => array(
			'label'      => __( 'Body Link Color', 'extra' ),
			'type'       => 'et_coloralpha',
		...
		'body_text_color'            => array(
			'label'      => __( 'Body Text Color', 'extra' ),
			'type'       => 'et_coloralpha',
		...
		'heading_text_color'         => array(
			'label'      => __( 'Heading Text Color', 'extra' ),
			'type'       => 'et_coloralpha',
			'default'    => 'rgba(0,0,0,0.75)',
			'value_bind' => array(
				'style'              => 'dynamic_selectors',
		...
		'archive_heading_text_color' => array(
			'label'      => __( 'Archive Heading Text Color', 'extra' ),
			'type'       => 'et_coloralpha',
			'default'    => 'rgba(0,0,0,0.75)',
			'value_bind' => array(
				'style'              => 'dynamic_selectors',
...
function extra_customizer_register_general_background_settings() {
	return array(
		'cover_background'              => array(
			'label'      => __( 'Stretch Background Image', 'extra' ),
			'type'       => 'checkbox',
			'default'    => 'on',
			'value_bind' => array(
				'style'    => 'class_toggle',
		...
		'boxed_layout_background_color' => array(
			'label'      => __( 'Boxed Layout - Background color', 'extra' ),
			'type'       => 'et_coloralpha',
			'default'    => '#FFFFFF',
			'value_bind' => array(
				'style'              => 'dynamic_selectors',
		...
		'background_color'              => array(
			'label'          => __( 'Background Color', 'extra' ),
			'type'           => 'et_coloralpha',
			'default'        => '#ecf0f5',
			'global_option'  => true,
...
function extra_customizer_register_header_and_navigation_header_format_settings() {
	return array(
		'header_style'          => array(
			'label'             => __( 'Left/Right or Centered?', 'extra' ),
			'type'              => 'radio',
		...
		'hide_nav_until_scroll' => array(
			'label'      => __( 'Hide Navigation Until Scroll', 'extra' ),
			'type'       => 'checkbox',
			'value_bind' => array(
				'style'    => 'class_toggle',
				'selector' => 'body',
...
function extra_customizer_register_header_and_navigation_primary_nav_settings() {
	return array(
		...
		'primary_nav_hide_logo_image'            => array(
			'label'      => __( 'Hide Logo Image', 'extra' ),
			'type'       => 'checkbox',
			'value_bind' => array(
				'style'    => 'el_toggle_reverse',
				'selector' => extra_get_dynamic_selector( 'logo' ),
			),
		),
		'primary_nav_height'                     => array(
			'label'       => __( 'Menu Height', 'extra' ),
			'type'        => 'range',
			'default'     => 124,
			'input_attrs' => array(
				'min'  => 80,
		...
		'primary_nav_active_link_color'          => array(
			'label'      => __( 'Hover/Active Link Color', 'extra' ),
			'type'       => 'et_coloralpha',
			'default'    => '#FFFFFF',
			'value_bind' => array(
				'style'              => 'dynamic_selectors',
		...
		'primary_nav_dropdown_background_color'  => array(
			'label'      => __( 'Dropdown Menu Background Color', 'extra' ),
			'type'       => 'et_coloralpha',
			'default'    => '#232323',
			'value_bind' => array(
				'style'              => 'dynamic_selectors',
		...
		'primary_nav_dropdown_line_color'        => array(
			'label'      => __( 'Dropdown Menu Line Color', 'extra' ),
			'type'       => 'et_coloralpha',
		...
		'primary_nav_dropdown_text_color'        => array(
			'label'      => __( 'Dropdown Menu Text Color', 'extra' ),
			'type'       => 'et_coloralpha',
			'default'    => 'rgba(255,255,255,0.6)',
			'value_bind' => array(
				'style'              => 'dynamic_selectors',
		...
		'primary_nav_dropdown_active_link_color' => array(
			'label'      => __( 'Dropdown Menu Hover/Active Link Color', 'extra' ),
			'type'       => 'et_coloralpha',
			'default'    => '#FFFFFF',
			'value_bind' => array(
				'style'              => 'dynamic_selectors',
		...
		'primary_nav_dropdown_animation'         => array(
			'label'             => __( 'Dropdown Menu Animation', 'extra' ),
			'type'              => 'select',
...
function extra_customizer_register_header_and_navigation_secondary_nav_settings() {
	return array(
		...
		'secondary_nav_trending_font_size'                => array(
			'label'       => __( 'Trending Text Size', 'extra' ),
			'type'        => 'range',
			'default'     => 14,
			'input_attrs' => array(
				'min'  => 10,
		...
		'secondary_nav_trending_font_style'               => array(
			'label'      => __( 'Trending Font Style', 'extra' ),
			'type'       => 'dropdown-font-styles',
			'value_bind' => array(
				'style'                    => 'dynamic_selectors_value_format_callback',
				'value_format_callback'    => 'extra_et_print_font_style_css_value',
		...
		'secondary_nav_trending_label_text_color'         => array(
			'label'      => __( 'Trending Label Text Color', 'extra' ),
			'type'       => 'et_coloralpha',
			'default'    => '#FFFFFF',
			'value_bind' => array(
				'style'              => 'dynamic_selectors',
		...
		'secondary_nav_trending_title_text_color'         => array(
			'label'      => __( 'Trending Title Text Color', 'extra' ),
			'type'       => 'et_coloralpha',
			'default'    => 'rgba(255,255,255,0.6)',
			'value_bind' => array(
				'style'              => 'dynamic_selectors',
		...
		'secondary_nav_icon_search_cart_font_size'        => array(
			'label'       => __( 'Search, Cart, & Icon Text Size', 'extra' ),
			'type'        => 'range',
			'default'     => 12,
			'input_attrs' => array(
				'min'  => 10,
		...
		'secondary_nav_icon_search_cart_letter_spacing'   => array(
			'label'       => __( 'Search, Cart, & Icon Letter Spacing', 'extra' ),
			'type'        => 'range',
			'default'     => 0,
			'input_attrs' => array(
				'min'  => -1,
		...
		'secondary_nav_icon_search_cart_font'             => array(
			'label'      => __( 'Search & Cart Font', 'extra' ),
			'type'       => 'dropdown-fonts',
			'value_bind' => array(
				'style'                    => 'dynamic_selectors_value_format_callback',
				'value_format_callback'    => 'extra_get_google_font_css_value',
		...
		'secondary_nav_icon_search_cart_font_style'       => array(
			'label'      => __( 'Search & Cart Font Style', 'extra' ),
			'type'       => 'dropdown-font-styles',
			'value_bind' => array(
				'style'                    => 'dynamic_selectors_value_format_callback',
				'value_format_callback'    => 'extra_et_print_font_style_css_value',
		...
		'secondary_nav_icon_search_cart_background_color' => array(
			'label'      => __( 'Search, Cart, & Icon Background Color', 'extra' ),
			'type'       => 'et_coloralpha',
			'default'    => 'rgba(255,255,255,0.1)',
			'value_bind' => array(
				'style'              => 'dynamic_selectors',
		...
		'secondary_nav_icon_search_cart_text_color'       => array(
			'label'      => __( 'Search, Cart, & Icon Text Color', 'extra' ),
			'type'       => 'et_coloralpha',
			'default'    => '#FFFFFF',
			'value_bind' => array(
				'style'              => 'dynamic_selectors',
...
function extra_customizer_register_header_and_navigation_header_elements_settings() {
	$settings = array(
		'show_header_social_icons' => array(
			'label'      => __( 'Show Social Icons', 'extra' ),
			'type'       => 'checkbox',
			'default'    => 'on',
			'value_bind' => array(
				'style'    => 'el_toggle',
		...
		'show_header_search'       => array(
			'label'      => __( 'Show Search Bar', 'extra' ),
			'type'       => 'checkbox',
			'default'    => 'on',
			'value_bind' => array(
				'style'    => 'el_toggle',
		...
		'show_header_trending'     => array(
			'label'      => __( 'Show Trending Bar', 'extra' ),
			'type'       => 'checkbox',
			'default'    => 'on',
			'value_bind' => array(
				'style'    => 'class_toggle',
		...
		'show_header_cart_total'   => array(
			'label'      => __( 'Show WooCommerce Cart', 'extra' ),
			'type'       => 'checkbox',
			'default'    => 'on',
			'value_bind' => array(
				'style'    => 'el_toggle',
...
function extra_customizer_register_social_networks_settings( $settings ) {
	...
	foreach ( extra_get_social_networks() as $social_network => $social_network_title ) {
		$settings[sprintf( '%s_url', $social_network )] = array(
			'label'             => sprintf( __( '%s URL', 'extra' ), $social_network_title ),
...
function extra_customizer_register_footer_typography_settings() {
	return array(
		'footer_heading_font_size'    => array(
			'label'       => __( 'Heading Text Size', 'extra' ),
			'type'        => 'range',
			'default'     => '14',
			'input_attrs' => array(
				'min'  => 10,
		...
		'footer_font_size'            => array(
			'label'       => __( 'Body/Link Text Size', 'extra' ),
			'type'        => 'range',
			'default'     => '14',
			'input_attrs' => array(
				'min'  => 10,
		...
		'footer_line_height'          => array(
			'label'       => __( 'Body/Link Line Height', 'extra' ),
			'type'        => 'range',
			'default'     => '1.7',
			'input_attrs' => array(
				'min'  => 0.8,
		...
		'footer_font_style'           => array(
			'label'      => __( 'Body/Link Font Style', 'extra' ),
			'type'       => 'dropdown-font-styles',
			'value_bind' => array(
				'style'                    => 'dynamic_selectors_value_format_callback',
				'value_format_callback'    => 'extra_et_print_font_style_css_value',
		...
		'footer_widget_text_color'    => array(
			'label'      => __( 'Widget Text Color', 'extra' ),
			'type'       => 'et_coloralpha',
			'default'    => 'rgba(255,255,255,0.6)',
			'value_bind' => array(
				'style'              => 'dynamic_selectors',
		...
		'footer_widget_link_color'    => array(
			'label'      => __( 'Widget Link Color', 'extra' ),
			'type'       => 'et_coloralpha',
			'default'    => '#FFFFFF',
			'value_bind' => array(
				'style'              => 'dynamic_selectors',
		...
		'footer_widget_heading_color' => array(
			'label'      => __( 'Widget Heading Color', 'extra' ),
			'type'       => 'et_coloralpha',
			'default'    => 'rgba(255,255,255,0.6)',
			'value_bind' => array(
				'style'              => 'dynamic_selectors',
		...
		'footer_widget_bullet_color'  => array(
			'label'      => __( 'Widget Bullet Color', 'extra' ),
			'type'       => 'et_coloralpha',
			'default'    => 'rgba(255,255,255,0.6)',
			'value_bind' => array(
				'style'              => 'dynamic_selectors',
...
function extra_customizer_register_footer_bottom_bar_settings() {
	return array(
		...
		'footer_bottom_credit_text_color'      => array(
			'label'      => __( 'Footer Credit Text Color', 'extra' ),
			'type'       => 'et_coloralpha',
			'default'    => 'rgba(255,255,255,0.6)',
			'value_bind' => array(
				'style'              => 'dynamic_selectors',
		...
		'footer_bottom_credit_font_style'      => array(
			'label'      => __( 'Footer Credit Font Style', 'extra' ),
			'type'       => 'dropdown-font-styles',
			'value_bind' => array(
				'style'                    => 'dynamic_selectors_value_format_callback',
				'value_format_callback'    => 'extra_et_print_font_style_css_value',
		...
		'footer_bottom_credit_font_size'       => array(
			'label'       => __( 'Footer Credit Text Size', 'extra' ),
			'type'        => 'range',
			'default'     => 13,
			'input_attrs' => array(
				'min'  => 10,
		...
		'footer_bottom_menu_link_color'        => array(
			'label'      => __( 'Footer Menu Link Color', 'extra' ),
			'type'       => 'et_coloralpha',
			'default'    => 'rgba(255,255,255,0.6)',
			'value_bind' => array(
				'style'              => 'dynamic_selectors',
		...
		'footer_bottom_menu_active_link_color' => array(
			'label'      => __( 'Footer Menu Active Link Color', 'extra' ),
			'type'       => 'et_coloralpha',
			'default'    => '#FFFFFF',
			'value_bind' => array(
				'style'              => 'dynamic_selectors',
		...
		'footer_bottom_menu_letter_spacing'    => array(
			'label'       => __( 'Footer Menu Letter Spacing', 'extra' ),
			'type'        => 'range',
			'default'     => 0,
			'input_attrs' => array(
				'min'  => -1,
		...
		'footer_bottom_menu_font_size'         => array(
			'label'       => __( 'Footer Menu Text Size', 'extra' ),
			'type'        => 'range',
			'default'     => '14',
			'input_attrs' => array(
				'min'  => 10,
		...
		'footer_bottom_menu_font_style'        => array(
			'label'      => __( 'Footer Menu Font Style', 'extra' ),
			'type'       => 'dropdown-font-styles',
			'value_bind' => array(
				'style'                    => 'dynamic_selectors_value_format_callback',
				'value_format_callback'    => 'extra_et_print_font_style_css_value',
		...
		'footer_bottom_social_icon_size'       => array(
			'label'       => __( 'Social Icons Size', 'extra' ),
			'type'        => 'range',
			'default'     => '16',
			'input_attrs' => array(
				'min'  => 10,
		...
		'footer_bottom_social_icon_color'      => array(
			'label'      => __( 'Social Icons Color', 'extra' ),
			'type'       => 'et_coloralpha',
			'default'    => 'rgba(255,255,255,0.6)',
			'value_bind' => array(
				'style'              => 'dynamic_selectors',
...
function extra_customizer_register_module_image_settings() {
	return array(
		'et_pb_image-animation' => array(
			'label'             => __( 'Animation', 'extra' ),
			'type'              => 'select',
			'sanitize_callback' => 'et_sanitize_image_animation',
			'choices'           => et_extra_image_animation_choices(),
			'description'       => __( 'This controls default direction of the lazy-loading animation.', 'extra' ),
			'value_bind'        => array(
				'style'    => 'class_toggle',
				'selector' => '.et_pb_image',
				'class'    => '_value_bind_to_value',
				'format'   => 'et_pb_animation_%value%',
			),
		),
	);
}
...
function extra_customizer_register_module_gallery_settings() {
	return array(
		'et_pb_gallery-zoom_icon_color'     => array(
			'label'      => __( 'Zoom Icon Color', 'extra' ),
			'type'       => 'et_coloralpha',
			'default'    => extra_global_accent_color(),
			'value_bind' => array(
				'style'              => 'dynamic_selectors',
				'property_selectors' => array(
					'color' => array(
		...
		'et_pb_gallery-hover_overlay_color' => array(
			'label'      => __( 'Hover Overlay Color', 'extra' ),
			'type'       => 'et_coloralpha',
		...
		'et_pb_gallery-title_font_size'     => array(
			'label'       => __( 'Title Font Size', 'extra' ),
			'type'        => 'range',
		...
		'et_pb_gallery-title_font_style'    => array(
			'label'      => __( 'Title Font Style', 'extra' ),
			'type'       => 'dropdown-font-styles',
		...
		'et_pb_gallery-caption_font_size'   => array(
			'label'       => __( 'Caption Font Size', 'extra' ),
			'type'        => 'range',
		...
		'et_pb_gallery-caption_font_style'  => array(
			'label'      => __( 'Caption Font Style', 'extra' ),
			'type'       => 'dropdown-font-styles',
...
function extra_customizer_register_module_blurb_settings() {
	return array(
		'et_pb_blurb-header_font_size' => array(
			'label'       => __( 'Header Font Size', 'extra' ),
			'type'        => 'range',
...
function extra_customizer_register_module_tabs_settings() {
	return array(
		...
		'et_pb_tabs-title_font_style' => array(
			'label'      => __( 'Title Font Style', 'extra' ),
			'type'       => 'dropdown-font-styles',
...
function extra_customizer_register_module_slider_settings() {
	return array(
		'et_pb_slider-padding'           => array(
			'label'       => __( 'Top & Bottom Padding', 'extra' ),
			'type'        => 'range',
		...
		'et_pb_slider-header_font_style' => array(
			'label'      => __( 'Header Font Style', 'extra' ),
			'type'       => 'dropdown-font-styles',
		...
		'et_pb_slider-body_font_size'    => array(
			'label'       => __( 'Content Font Size', 'extra' ),
			'type'        => 'range',
		...
		'et_pb_slider-body_font_style'   => array(
			'label'      => __( 'Content Font Style', 'extra' ),
			'type'       => 'dropdown-font-styles',
			'default'    => ET_Global_Settings::get_value( 'et_pb_slider-content_font_style', 'default' ),
			'value_bind' => array(
				'style'                    => 'dynamic_selectors_value_format_callback',
				'value_format_callback'    => 'extra_et_print_font_style_css_value',
				'use_only_formatted_value' => true,
...
function extra_customizer_register_module_testimonial_settings() {
	...
	$settings = $settings + extra_customizer_font_style_setting( array(
		'setting'   => 'et_pb_testimonial-author_name_font_style',
		'label'     => __( 'Name Font Style', 'extra' ),
		'type'      => 'font_style',
		'selectors' => array(
		...
		'label'     => __( 'Details Font Style', 'extra' ),
		'type'      => 'font_style',
		'selectors' => array(
		...
		'et_pb_testimonial-portrait_border_radius' => array(
			'label'       => __( 'Portrait Border Radius', 'extra' ),
			'type'        => 'range',
		...
		'et_pb_testimonial-portrait_width'         => array(
			'label'       => __( 'Image Width', 'extra' ),
			'type'        => 'range',
		...
		'et_pb_testimonial-portrait_height'        => array(
			'label'       => __( 'Image Height', 'extra' ),
			'type'        => 'range',
...
function extra_customizer_register_module_pricing_table_settings() {
	...
	$settings = $settings + extra_customizer_font_size_setting( array(
		...
		'label'     => __( 'Subheader Font Size', 'extra' ),
		'type'      => 'range',
		'min'       => 10,
		'max'       => 32,
		'selectors' => array(
		...
		'label'     => __( 'Subheader Font Style', 'extra' ),
		'type'      => 'font_style',
		'selectors' => array(
			'.et_pb_best_value',
		),
		...
		'label'     => __( 'Price Font Size', 'extra' ),
		'type'      => 'range',
		'min'       => 10,
		'max'       => 100,
		'selectors' => array(
		...
		'label'     => __( 'Price Font Style', 'extra' ),
		'type'      => 'font_style',
		'selectors' => array(
			'.et_pb_sum',
		),
...
function extra_customizer_register_module_portfolio_settings() {
	...
	$settings = $settings + array(
		'et_pb_portfolio-zoom_icon_color'     => array(
			'label'      => __( 'Zoom Icon Color', 'extra' ),
			'type'       => 'et_coloralpha',
		...
		'et_pb_portfolio-hover_overlay_color' => array(
			'label'      => __( 'Hover Overlay Color', 'extra' ),
			'type'       => 'et_coloralpha',
...
function extra_customizer_register_module_filterable_portfolio_settings() {
	...
	$settings = $settings + array(
		'et_pb_filterable_portfolio-zoom_icon_color'     => array(
			'label'      => __( 'Zoom Icon Color', 'extra' ),
			'type'       => 'et_coloralpha',
		...
		'et_pb_filterable_portfolio-hover_overlay_color' => array(
			'label'      => __( 'Hover Overlay Color', 'extra' ),
			'type'       => 'et_coloralpha',
		...
		'label'     => __( 'Filter Font Size', 'extra' ),
		'type'      => 'range',
		'min'       => 10,
		'max'       => 32,
		'selectors' => array(
		...
		'label'     => __( 'Filter Font Style', 'extra' ),
		'type'      => 'font_style',
		'selectors' => array(
			'.et_pb_filterable_portfolio .et_pb_portfolio_item .post-meta',
		),
...
function extra_customizer_register_module_bar_counter_settings() {
	...
	$settings = $settings + extra_customizer_font_size_setting( array(
		...
		'label'     => __( 'Percent Font Size', 'extra' ),
		'type'      => 'range',
		'min'       => 10,
		'max'       => 32,
		'selectors' => array(
		...
		'label'     => __( 'Percent Font Style', 'extra' ),
		'type'      => 'font_style',
		'selectors' => array(
			'.et_pb_counters .et_pb_counter_amount',
		),
		...
		'et_pb_counters-border_radius' => array(
			'label'       => __( 'Bar Border Radius', 'extra' ),
			'type'        => 'range',
...
function extra_customizer_register_module_circle_counter_settings() {
	...
	$settings = $settings + extra_customizer_font_size_setting( array(
		...
		'label'     => __( 'Number Font Size', 'extra' ),
		'type'      => 'range',
		'min'       => 10,
		'max'       => 72,
		'selectors' => array(
		...
		'label'     => __( 'Number Font Style', 'extra' ),
		'type'      => 'font_style',
		'selectors' => array(
			'.et_pb_circle_counter .percent p',
		),
...
function extra_customizer_register_module_accordion_settings() {
	...
	$settings = $settings + extra_customizer_font_size_setting( array(
		...
		'label'     => __( 'Closed Title Font Style', 'extra' ),
		'type'      => 'font_style',
		'selectors' => array(
		...
		'label'     => __( 'Toggle Icon Size', 'extra' ),
		'type'      => 'range',
		'min'       => 16,
		'max'       => 32,
		'selectors' => array(
...
function extra_customizer_register_module_contact_form_settings() {
	...
	$settings = $settings + extra_customizer_font_size_setting( array(
		...
		'label'     => __( 'Input Font Size', 'extra' ),
		'type'      => 'range',
		'min'       => 10,
		'max'       => 32,
		'selectors' => array(
		...
		'label'     => __( 'Input Font Style', 'extra' ),
		'type'      => 'font_style',
		'selectors' => array(
			'.et_pb_contact_form_container .et_pb_contact p input',
			'.et_pb_contact_form_container .et_pb_contact p textarea',
		...
		'et_pb_contact_form-padding' => array(
			'label'       => __( 'Input Field Padding', 'extra' ),
			'type'        => 'range',
		...
		'label'     => __( 'Captcha Font Size', 'extra' ),
		'type'      => 'range',
		'min'       => 10,
		'max'       => 32,
		'selectors' => array(
		...
		'label'     => __( 'Captcha Font Style', 'extra' ),
		'type'      => 'font_style',
		'selectors' => array(
			'.et_pb_contact_captcha_question',
		),
...
function extra_customizer_register_module_sidebar_settings() {
	...
	$settings = $settings + extra_customizer_font_size_setting( array(
		...
		'label'     => __( 'Widget Header Font Size', 'extra' ),
		'type'      => 'range',
		'min'       => 10,
		'max'       => 32,
		'selectors' => array(
		...
		'label'     => __( 'Widget Header Font Style', 'extra' ),
		'type'      => 'font_style',
		'selectors' => array(
			'.et_pb_widget_area h4',
		),
		...
		'et_pb_sidebar-remove_border' => array(
			'label'      => __( 'Remove Vertical Divider', 'extra' ),
			'type'       => 'checkbox',
			'value_bind' => array(
				'style'    => 'class_toggle',
				'selector' => 'body',
				'class'    => 'et_pb_no_sidebar_vertical_divider',
			),
		),
	);
...
function extra_customizer_register_module_divider_settings() {
	$settings = array(
		'et_pb_divider-show_divider'     => array(
			'label' => __( 'Show Divider', 'extra' ),
			'type'  => 'checkbox',
		),
		'et_pb_divider-divider_style'    => array(
			'label'             => __( 'Divider Style', 'extra' ),
			'type'              => 'select',
			'default'           => ET_Global_Settings::get_value( 'et_pb_divider-divider_style', 'default' ),
			'choices'           => et_extra_divider_style_choices(),
		...
		'et_pb_divider-divider_weight'   => array(
			'label'       => __( 'Divider Weight', 'extra' ),
			'type'        => 'range',
		...
		'et_pb_divider-divider_height'   => array(
			'label'       => __( 'Divider Height', 'extra' ),
			'type'        => 'range',
		...
		'et_pb_divider-divider_position' => array(
			'label'             => __( 'Divider Position', 'extra' ),
			'type'              => 'select',
...
function extra_customizer_register_module_person_settings() {
	...
	$settings = $settings + extra_customizer_font_size_setting( array(
		...
		'label'     => __( 'Social Network Icon Size', 'extra' ),
		'type'      => 'range',
		'min'       => 16,
		'max'       => 32,
		'selectors' => array(
...
function extra_customizer_register_module_blog_settings() {
	...
	$settings = $settings + extra_customizer_font_size_setting( array(
		...
		'label'     => __( 'Post Title Font Size', 'extra' ),
		'type'      => 'range',
		'min'       => 10,
		'max'       => 32,
		'selectors' => array(
		...
		'label'     => __( 'Post Title Font Style', 'extra' ),
		'type'      => 'font_style',
		'selectors' => array(
			'.et_pb_posts .et_pb_post h2',
		),
		...
		'label'     => __( 'Meta Font Style', 'extra' ),
		'type'      => 'font_style',
		'selectors' => array(
			'.et_pb_posts .et_pb_post .post-meta',
		),
...
function extra_customizer_register_module_masonry_settings() {
	...
	$settings = $settings + extra_customizer_font_size_setting( array(
		...
		'setting'   => 'et_pb_blog_masonry-meta_font_style',
		'label'     => __( 'Meta Font Style', 'extra' ),
		'type'      => 'font_style',
		'selectors' => array(
			'.et_pb_blog_grid .et_pb_post .post-meta',
...
function extra_customizer_register_module_shop_settings() {
	...
	$settings = $settings + extra_customizer_font_size_setting( array(
		...
		'label'     => __( 'Product Name Font Size', 'extra' ),
		'type'      => 'range',
		'min'       => 10,
		'max'       => 32,
		'selectors' => array(
		...
		'label'     => __( 'Product Name Font Style', 'extra' ),
		'type'      => 'font_style',
		'selectors' => array(
			'.woocommerce ul.products li.product .product-wrapper h3',
			'.woocommerce-page ul.products li.product h3',
		...
		'label'     => __( 'Sale Badge Font Size', 'extra' ),
		'type'      => 'range',
		'min'       => 10,
		'max'       => 32,
		'selectors' => array(
		...
		'label'     => __( 'Sale Badge Font Style', 'extra' ),
		'type'      => 'font_style',
		'selectors' => array(
			'.woocommerce span.onsale',
			'.woocommerce-page span.onsale',
		...
		'label'     => __( 'Sale Price Font Size', 'extra' ),
		'type'      => 'range',
		'min'       => 10,
		'max'       => 32,
		'selectors' => array(
		...
		'label'     => __( 'Sale Price Font Style', 'extra' ),
		'type'      => 'font_style',
		'selectors' => array(
			'.woocommerce ul.products li.product .price ins .amount',
			'.woocommerce-page ul.products li.product .price ins .amount',
...
function extra_customizer_register_module_countdown_timer_settings() {
	...
	$settings = $settings + extra_customizer_font_size_setting( array(
		'setting'   => 'et_pb_countdown_timer-header_font_size',
		'label'     => __( 'Header Font Size', 'extra' ),
		'type'      => 'range',
		'min'       => 10,
		'max'       => 32,
...
function extra_customizer_register_module_social_follow_settings() {
	$settings = array(
		'et_pb_social_media_follow-icon_size' => array(
			'label'       => __( 'Follow Font & Icon Size', 'extra' ),
			'type'        => 'range',
	...
	$settings = $settings + extra_customizer_font_style_setting( array(
		'setting'   => 'et_pb_social_media_follow-_button_font_style',
		'label'     => __( 'Button Font Style', 'extra' ),
		'type'      => 'font_style',
		'selectors' => array(
			'.et_pb_social_media_follow li a.follow_button',
		),
...
function extra_customizer_settings( $set = 'theme' ) {
	...
	$customizer_settings['theme'] = array(
		'general'               => array(
			'title'    => __( 'General Settings', 'extra' ),
			'priority' => 1,
			'sections' => array(
				'layout'     => array(
					'title' => __( 'Layout Settings', 'extra' ),
				),
				'typography' => array(
					'title' => __( 'Typography Settings', 'extra' ),
				),
				'background' => array(
					'title' => __( 'Background Settings', 'extra' ),
				),
			),
		),
		'header_and_navigation' => array(
			'title'    => __( 'Header & Navigation Settings', 'extra' ),
			'priority' => 2,
			'sections' => array(
				'header_format'   => array(
					'title' => __( 'Header Format Settings', 'extra' ),
				),
				'primary_nav'     => array(
					'title' => __( 'Primary Menu Bar Settings', 'extra' ),
				),
				'secondary_nav'   => array(
					'title' => __( 'Secondary Menu Bar Settings', 'extra' ),
				),
				'fixed_nav'       => array(
					'title' => __( 'Fixed Navigation Settings', 'extra' ),
				),
				'header_elements' => array(
					'title' => __( 'Header Elements Settings', 'extra' ),
				),
			),
		),
		'social_networks'       => array(
			'title'    => __( 'Social Media Links', 'extra' ),
			'priority' => 3,
			'sections' => array(
				'social_networks' => array(
					'title' => __( 'Social Media Networks', 'extra' ),
				),
			),
		),
		'footer'                => array(
			'title'    => __( 'Footer Settings', 'extra' ),
			'priority' => 4,
			'sections' => array(
				'layout'          => array(
					'title' => __( 'Layout', 'extra' ),
				),
				'typography'      => array(
					'title' => __( 'Typography', 'extra' ),
				),
				'footer_elements' => array(
					'title' => __( 'Footer Elements', 'extra' ),
				),
				'bottom_bar'      => array(
					'title' => __( 'Bottom Bar', 'extra' ),
				),
			),
		),
		'buttons'               => array(
			'title'    => __( 'Buttons', 'extra' ),
			'priority' => 5,
			'sections' => array(
				'styles'       => array(
					'title' => __( 'Button Styles', 'extra' ),
				),
				'hover_styles' => array(
					'title' => __( 'Button Hover Styles', 'extra' ),
				),
			),
		),
	);
	...
	$customizer_settings['modules'] = array(
		...
		'module_filterable_portfolio' => array(
			'sections' => array(
				'module_filterable_portfolio' => array(
					'title' => __( 'Filterable Portfolio', 'extra' ),
				),
			),
		),
		...
		'module_fullwidth_slider'     => array(
			'sections' => array(
				'module_fullwidth_slider' => array(
					'title' => __( 'Fullwidth Slider', 'extra' ),
				),
			),
		),
	);
...
function extra_customize_static_front_page_options_register( $wp_customize ) {
	...
	$wp_customize->add_control( 'show_on_front', array(
		'label'    => __( 'Front page displays', 'extra' ),
		'section'  => 'static_front_page',
		'type'     => 'radio',
		'priority' => 5,
		'choices'  => array(
			'posts'  => __( 'Your latest posts', 'extra' ),
			'page'   => __( 'A static page', 'extra' ),
			'layout' => __( 'An Extra Category Layout', 'extra' ),
		),
	) );
	...
	$wp_customize->add_control( 'show_on_front_layout', array(
		'label'   => __( 'Extra Category Layout', 'extra' ),
		'section' => 'static_front_page',
		'type'    => 'select',
		'choices' => $layouts,
	) );
