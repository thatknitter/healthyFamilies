...
function extra_setup_project_tag_tax() {
	$labels = array(
		'name'               => _x( 'Projects', 'project type general name', 'extra' ),
		'singular_name'      => _x( 'Project', 'project type singular name', 'extra' ),
		'add_new'            => _x( 'Add New', 'project item', 'extra' ),
		'add_new_item'       => __( 'Add New Project', 'extra' ),
		'edit_item'          => __( 'Edit Project', 'extra' ),
		'new_item'           => __( 'New Project', 'extra' ),
		'all_items'          => __( 'All Projects', 'extra' ),
		'view_item'          => __( 'View Project', 'extra' ),
		'search_items'       => __( 'Search Projects', 'extra' ),
	...
	$labels = array(
		'name'                       => _x( 'Project Skills', 'Project Skill name', 'extra' ),
		'singular_name'              => _x( 'Project Skill', 'Project skill singular name', 'extra' ),
		'search_items'               => __( 'Search Project Skills', 'extra' ),
		'all_items'                  => __( 'All Project Skills', 'extra' ),
		'parent_item'                => __( 'Parent Skill', 'extra' ),
		'parent_item_colon'          => __( 'Parent Skill:', 'extra' ),
		'edit_item'                  => __( 'Edit Skill', 'extra' ),
		'update_item'                => __( 'Update Skill', 'extra' ),
		'add_new_item'               => __( 'Add New Project Skill', 'extra' ),
		'new_item_name'              => __( 'New Skill Name', 'extra' ),
		'menu_name'                  => __( 'Project Skills', 'extra' ),
		'popular_items'              => __( 'Popular Skills', 'extra' ),
		'separate_items_with_commas' => __( 'Separate Skills with Commas', 'extra' ),
		'add_or_remove_items'        => __( 'Add or Remove Skills', 'extra' ),
		'choose_from_most_used'      => __( 'Choose From the Most Used Skills', 'extra' ),
		'not_found'                  => __( 'No Skills Found', 'extra' ),
	);
...
function et_extra_library_custom_scripts() {
	...
	if ( 'et_pb_layout' === $typenow ) {
		...
		wp_enqueue_script( 'extra-library-scripts', get_template_directory_uri() . '/includes/scripts/library_scripts_extra.js', array( 'jquery' ) );
	}
}

function et_pb_generate_extra_checkbox() {
	$output = sprintf( '<label>%1$s<input type="checkbox" value="extra_layout" id="et_pb_extra_layout" /></label>', __( 'Extra - Layout', 'extra' ) );
	return $output;
}
