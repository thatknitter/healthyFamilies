...
class ET_Builder_Module_Posts extends ET_Builder_Module {
	...
	function init() {
		...
		$this->advanced_options = array(
			'fonts'                 => array(
				...
				'main_title' => array(
					'label'          => __( 'Main Title', 'et_builder' ),
					'css'            => array(
				...
				'list_title' => array(
					'label'       => __( 'List Title', 'et_builder' ),
					'css'         => array(
	...
	function get_fields() {
		$fields = array(
			'category_id'                 => array(
				'label'           => __( 'Categories', 'extra' ),
				'type'            => 'custom',
				'description'     => __( 'Choose categories.', 'extra' ),
				'renderer'        => array(
					$this,
			...
			'display_featured_posts_only' => array(
				'label'           => __( 'Display Featured Posts Only', 'extra' ),
				'type'            => 'yes_no_button',
				'options'         => array(
					'off' => __( 'No', 'extra' ),
					'on'  => __( 'Yes', 'extra' ),
				),
				'description'     => __( 'Only display featured posts.', 'extra' ),
				'priority'        => 5,
				'option_category' => 'configuration',
			),
			'heading_style'               => array(
				'label'           => __( 'Heading Style', 'extra' ),
				'type'            => 'select',
				'options'         => array(
					'category' => __( 'Primary Heading: Category Name, Sub Heading: Filter', 'extra' ),
					'filter'   => __( 'Primary Heading: Filter, Sub Heading: Category Name', 'extra' ),
					'custom'   => __( 'Custom Title', 'extra' ),
				),
				'description'     => __( 'Choose a heading style.', 'extra' ),
				'affects'         => array(
			...
			'heading_primary'             => array(
				'label'           => __( 'Primary Heading', 'extra' ),
				'type'            => 'input',
				'description'     => __( 'The primary heading.', 'extra' ),
				'depends_show_if' => 'custom',
				'option_category' => 'configuration',
			),
			'heading_sub'                 => array(
				'label'           => __( 'Sub Heading', 'extra' ),
				'type'            => 'input',
				'description'     => __( 'The sub heading.', 'extra' ),
				'depends_show_if' => 'custom',
				'option_category' => 'configuration',
			),
			'posts_per_page'              => array(
				'label'           => __( 'Posts Limit', 'extra' ),
				'type'            => 'input',
				'description'     => __( 'The number of posts shown.', 'extra' ),
				'priority'        => 3,
				'option_category' => 'configuration',
			),
			'orderby'                     => array(
				'label'           => __( 'Sort Method', 'extra' ),
				'type'            => 'select',
				'options'         => array(
					'date'          => __( 'Most Recent', 'extra' ),
					'comment_count' => __( 'Most Popular', 'extra' ),
					'rating'        => __( 'Highest Rated', 'extra' ),
				),
				'description'     => __( 'Choose a sort method.', 'extra' ),
				'option_category' => 'configuration',
			),
			'order'                       => array(
				'label'           => __( 'Sort Order', 'extra' ),
				'type'            => 'select',
				'options'         => array(
					'desc' => __( 'Descending', 'extra' ),
					'asc'  => __( 'Ascending', 'extra' ),
				),
				'description'     => __( 'Choose a sort order.', 'extra' ),
				'option_category' => 'configuration',
			),
			'show_thumbnails'             => array(
				'label'           => __( 'Show Featured Image', 'extra' ),
				'type'            => 'yes_no_button',
				'options'         => array(
					'on'  => __( 'Yes', 'extra' ),
					'off' => __( 'No', 'extra' ),
				),
				'description'     => __( "Turn the display of each post's featured image on or off.", 'extra' ),
				'priority'        => 5,
				'option_category' => 'configuration',
			),
			'show_author'                 => array(
				'label'           => __( 'Show Author', 'extra' ),
				'type'            => 'yes_no_button',
				'options'         => array(
					'on'  => __( 'Yes', 'extra' ),
					'off' => __( 'No', 'extra' ),
				),
				'description'     => __( "Turn the display of each post's author on or off.", 'extra' ),
				'priority'        => 5,
				'option_category' => 'configuration',
			),
			'show_categories'             => array(
				'label'           => __( 'Show Categories', 'extra' ),
				'type'            => 'yes_no_button',
				'options'         => array(
					'on'  => __( 'Yes', 'extra' ),
					'off' => __( 'No', 'extra' ),
				),
				'description'     => __( "Turn the display of each post's categories on or off.", 'extra' ),
				'priority'        => 5,
				'option_category' => 'configuration',
			),
			'show_comments'               => array(
				'label'           => __( 'Show Comments', 'extra' ),
				'type'            => 'yes_no_button',
				'options'         => array(
					'on'  => __( 'Yes', 'extra' ),
					'off' => __( 'No', 'extra' ),
				),
				'description'     => __( "Turn the display of each post's ccomments on or off.", 'extra' ),
				'priority'        => 5,
				'option_category' => 'configuration',
			),
			'show_rating'                 => array(
				'label'           => __( 'Show Rating', 'extra' ),
				'type'            => 'yes_no_button',
				'options'         => array(
					'on'  => __( 'Yes', 'extra' ),
					'off' => __( 'No', 'extra' ),
				),
				'description'     => __( "Turn the display of each post's rating on or off.", 'extra' ),
				'priority'        => 5,
				'option_category' => 'configuration',
			),
			'show_date'                   => array(
				'label'           => __( 'Show Date', 'extra' ),
				'type'            => 'yes_no_button',
				'options'         => array(
					'on'  => __( 'Yes', 'extra' ),
					'off' => __( 'No', 'extra' ),
				...
				'description'     => __( "Turn the dispay of each post's date on or off.", 'extra' ),
				'priority'        => 5,
				'option_category' => 'configuration',
			),
			'date_format'                 => array(
				'label'               => __( 'Date Format', 'extra' ),
				'type'                => 'input',
				'depends_show_if_not' => "off",
				'description'         => __( 'The format for the date display in PHP date() format', 'extra' ),
				'option_category'     => 'configuration',
			),
			...
			'hover_overlay_icon_color'    => array(
				'label'        => __( 'Hover Overlay Icon Color', 'et_builder' ),
				'type'         => 'color-alpha',
				'custom_color' => true,
				'tab_slug'     => 'advanced',
				'priority'     => 26,
			...
			'hover_overlay_icon'          => array(
				'label'               => __( 'Hover Overlay Icon Picker', 'et_builder' ),
				'type'                => 'text',
				'option_category'     => 'configuration',
			...
			'admin_label'                 => array(
				'label'       => __( 'Admin Label', 'extra' ),
				'type'        => 'text',
				'description' => __( 'This will change the label of the module in the builder for easy identification.', 'extra' ),
			),
			'module_id'                   => array(
				'label'           => __( 'CSS ID', 'extra' ),
				'type'            => 'text',
				'description'     => __( 'Enter an optional CSS ID to be used for this module. An ID can be used to create custom CSS styling, or to create links to particular sections of your page.', 'extra' ),
				'option_category' => 'configuration',
			),
			'module_class'                => array(
				'label'           => __( 'CSS Class', 'extra' ),
				'type'            => 'text',
				'description'     => __( 'Enter optional CSS classes to be used for this module. A CSS class can be used to create custom CSS styling. You can add multiple classes, separated with a space.', 'extra' ),
				'option_category' => 'configuration',
			),
			'max_width'                   => array(
		...
		$advanced_design_fields = array(
			'post_format_icon_bg_color' => array(
				'label'        => __( 'Post Format Icon Background Color', 'et_builder' ),
				'type'         => 'color-alpha',
				'custom_color' => true,
				'tab_slug'     => 'advanced',
				'priority'     => 25,
			...
			'remove_drop_shadow'        => array(
				'label'           => __( 'Remove Drop Shadow', 'et_builder' ),
				'type'            => 'yes_no_button',
				'option_category' => 'layout',
				'options'         => array(
	...
	function shortcode_callback( $atts, $content = null, $function_name ) {
		...
		switch ( $this->shortcode_atts['orderby'] ) {
			case 'comment_count':
				$filter_title = __( 'Popular', 'extra' );
				break;
			case 'rating':
				$filter_title = __( 'Top Rated', 'extra' );
				break;
			case 'date':
			default:
				$filter_title = __( 'Latest', 'extra' );
				break;
		}
...
class ET_Builder_Module_Tabbed_Posts extends ET_Builder_Module {
	...
	function init() {
		...
		$this->name = __( 'Tabbed Posts', 'extra' );
		...
		$this->custom_css_options = array(
			...
			'tab_item'               => array(
				'label'    => __( 'Tab Item', 'et_builder' ),
				'selector' => '.tabs li',
			),
			'tab_item_hover'         => array(
				'label'    => __( 'Tab Item Hover', 'et_builder' ),
				'selector' => '.tabs li:hover',
			),
			'tab_item_active'        => array(
				'label'    => __( 'Tab Item Active', 'et_builder' ),
	...
	function get_fields() {
		...
		$advanced_design_fields = array(
			...
			'active_tab_text_color'         => array(
				'label'        => __( 'Active Tab Text Color', 'et_builder' ),
				'type'         => 'color-alpha',
				'custom_color' => true,
				'tab_slug'     => 'advanced',
			),
...
class ET_Builder_Module_Tabbed_Posts_Tab extends ET_Builder_Module_Posts {
	...
	function init() {
		...
		$this->advanced_setting_title_text = __( 'New Tab', 'extra' );
		$this->settings_text               = __( 'Tab Settings', 'extra' );
	...
	function get_fields() {
		$fields = array(
			'category_id'                 => array(
				'label'           => __( 'Category', 'extra' ),
				'type'            => 'custom',
				'description'     => __( 'Choose a category.', 'extra' ),
				'renderer'        => array(
					$this,
					'category_field_renderer',
				),
...
class ET_Builder_Module_Posts_Carousel extends ET_Builder_Module_Posts {
	...
	function init() {
		...
		$this->name = __( 'Posts Carousel', 'extra' );
		...
		$this->custom_css_options = array(
			...
			'post_hentry'       => array(
				'label'    => __( 'Post Entry', 'et_builder' ),
				'selector' => '.hentry',
			),
			'post_title'        => array(
				'label'    => __( 'Post Title', 'et_builder' ),
			...
			'nav'               => array(
				'label'    => __( 'Nav', 'et_builder' ),
				'selector' => '.et-pb-slider-arrows a',
			),
			'nav_hover'         => array(
				'label'    => __( 'Nav Hover', 'et_builder' ),
				'selector' => '.et-pb-slider-arrows a:hover',
			),
			'nav_icon'          => array(
				'label'    => __( 'Nav Icon', 'et_builder' ),
				'selector' => '.et-pb-slider-arrows a:before',
			),
			'nav_icon_hover'    => array(
				'label'    => __( 'Nav Icon Hover', 'et_builder' ),
	...
	function get_fields() {
		...
		$new_fields = array(
			'enable_autoplay'    => array(
				'label'           => __( 'Enable Autoplay', 'extra' ),
				'type'            => 'yes_no_button',
				'options'         => array(
					'off' => __( 'No', 'extra' ),
					'on'  => __( 'Yes', 'extra' ),
				...
				'description'     => __( 'Turn the autoplay feature on or off.', 'extra' ),
				'priority'        => 6,
				'option_category' => 'configuration',
			),
			'autoplay_speed'     => array(
				'label'           => __( 'Autoplay Speed', 'extra' ),
				'type'            => 'input',
				'depends_show_if' => "on",
				'description'     => __( 'The speed, in seconds, in which it will auto rotate to the next slide.', 'extra' ),
				'priority'        => 6,
				'option_category' => 'configuration',
			),
			'nav_arrow_color'    => array(
				'label'        => __( 'Nav Arrow Color', 'et_builder' ),
				'type'         => 'color-alpha',
				'custom_color' => true,
				'tab_slug'     => 'advanced',
			),
			'nav_arrow_bg_color' => array(
				'label'        => __( 'Nav Arrow Background Color', 'et_builder' ),
				'type'         => 'color-alpha',
				'custom_color' => true,
				'tab_slug'     => 'advanced',
			),
...
class ET_Builder_Module_Featured_Posts_Slider extends ET_Builder_Module_Posts_Carousel {
	...
	function init() {
		...
		$this->name = __( 'Featured Posts Slider', 'extra' );
		...
		$this->custom_css_options = array(
			...
			'post_caption'           => array(
				'label'    => __( 'Post Caption', 'et_builder' ),
			...
			'post_meta_icon'         => array(
				'label'    => __( 'Post Meta Icons (Rating &amp; Comment)', 'et_builder' ),
				'selector' => '.hentry .post-meta .post-meta-icon:before',
			),
			'pagination_item'        => array(
				'label'    => __( 'Pagination Item', 'et_builder' ),
				'selector' => '.slick-dots li button',
			),
			'pagination_item_active' => array(
				'label'    => __( 'Pagination Item Active', 'et_builder' ),
	...
	function get_fields() {
		...
		$fields['slide_caption_background'] = array(
			'label'        => __( 'Caption Background Color', 'et_builder' ),
			'type'         => 'color-alpha',
			'custom_color' => true,
			'tab_slug'     => 'advanced',
		);
...
class ET_Builder_Module_Posts_Blog_Feed extends ET_Builder_Module_Posts {
	...
	function init() {
		...
		$this->name = __( 'Blog Feed Standard', 'extra' );
	...
	function get_fields() {
		...
		$new_fields = array(
			'feed_title'                 => array(
				'label'           => __( 'Blog Feed Title', 'extra' ),
				'type'            => 'input',
				'description'     => __( 'This is an optional title to display for this module.', 'extra' ),
				'priority'        => 2,
				'option_category' => 'configuration',
			),
			'posts_per_page'             => array(
				'label'           => __( 'Posts Per Page', 'extra' ),
				'type'            => 'input',
				'description'     => __( 'The number of posts shown per page.', 'extra' ),
				'priority'        => 3,
				'option_category' => 'configuration',
			),
			'show_pagination'            => array(
				'label'           => __( 'Show Pagination', 'extra' ),
				'type'            => 'yes_no_button',
				'options'         => array(
					'on'  => __( 'Yes', 'extra' ),
					'off' => __( 'No', 'extra' ),
				),
				'description'     => __( 'Turn pagination on or off.', 'extra' ),
				'priority'        => 5,
				'option_category' => 'configuration',
			),
			'show_author'                => array(
			...
			'content_length'             => array(
				'label'           => __( 'Content', 'extra' ),
				'type'            => 'select',
				'options'         => array(
					'excerpt' => __( 'Show Excerpt', 'extra' ),
					'full'    => __( "Show Full Content", 'extra' ),
				),
				'affects'         => array(
					'#et_pb_show_more',
				),
				'description'     => __( "Display the post's exceprt or full content. If full content, then it will truncate to the more tag if used.", 'extra' ),
				'option_category' => 'configuration',
			),
			'show_more'                  => array(
				'label'           => __( 'Show Read More Button', 'extra' ),
				'type'            => 'yes_no_button',
				'options'         => array(
					'on'  => __( 'Yes', 'extra' ),
					'off' => __( 'No', 'extra' ),
				...
				'description'     => __( 'Here you can define whether to show "read more" link after the excerpts or not.', 'extra' ),
				'priority'        => 5,
				'option_category' => 'configuration',
			),
			'show_date'                  => array(
			...
			'pagination_color'           => array(
				'label'        => __( 'Pagination Color', 'et_builder' ),
				'type'         => 'color-alpha',
				'custom_color' => true,
				'tab_slug'     => 'advanced',
				'priority'     => 28,
			...
			'pagination_bg_color'        => array(
				'label'        => __( 'Pagination Background Color', 'et_builder' ),
				'type'         => 'color-alpha',
				'custom_color' => true,
				'tab_slug'     => 'advanced',
				'priority'     => 29,
			...
			'pagination_active_color'    => array(
				'label'        => __( 'Pagination Active Color', 'et_builder' ),
				'type'         => 'color-alpha',
				'custom_color' => true,
				'tab_slug'     => 'advanced',
				'priority'     => 30,
			...
			'pagination_active_bg_color' => array(
				'label'        => __( 'Pagination Active Background Color', 'et_builder' ),
				'type'         => 'color-alpha',
				'custom_color' => true,
				'tab_slug'     => 'advanced',
				'priority'     => 31,
...
class ET_Builder_Module_Posts_Blog_Feed_Masonry extends ET_Builder_Module_Posts_Blog_Feed {
	...
	function init() {
		$this->template_name = 'module-posts-blog-feed';
		$this->name = __( 'Blog Feed Masonry', 'extra' );
	...
	function get_fields() {
		...
		$fields['post_bg_color'] = array(
			'label'        => __( 'Post Background Color', 'et_builder' ),
			'type'         => 'color-alpha',
			'custom_color' => true,
			'tab_slug'     => 'advanced',
			'priority'     => 5,
...
class ET_Builder_Module_Ads extends ET_Builder_Module {
	...
	function init() {
		...
		$this->custom_css_options = array(
			'ad_link'  => array(
				'label'    => __( 'Ad Link', 'et_builder' ),
				'selector' => 'a',
			),
			'ad_image' => array(
				'label'    => __( 'Ad Image', 'et_builder' ),
				'selector' => 'a img',
			),
		);
	}
	...
	function get_fields() {
		$fields = array(
			'header_text'       => array(
				'label'           => __( 'Header Text', 'extra' ),
				'type'            => 'text',
				'description'     => __( 'Text for the header of the module. Leave blank for no header for the module.', 'extra' ),
				'option_category' => 'configuration',
			),
			'header_text_color' => array(
				'label'           => __( 'Header Text Color', 'extra' ),
				'type'            => 'color-alpha',
				'description'     => __( 'This will be used as the text color for the header text of the module.', 'extra' ),
				'option_category' => 'configuration',
			),
			'border'            => array(
				'label'           => __( 'Show Top Border?', 'extra' ),
				'type'            => 'yes_no_button',
				'options'         => array(
					'off' => __( 'No', 'extra' ),
					'on'  => __( 'Yes', 'extra' ),
				...
				'description'     => __( 'This will add a border to the top side of the module.', 'extra' ),
				'option_category' => 'configuration',
			),
			'border_color'      => array(
				...
				'type'                => 'color-alpha',
				'depends_show_if_not' => 'off',
				'description'         => __( 'This will be used as the border color for this module.', 'extra' ),
			),
			'admin_label'       => array(
				'label'       => __( 'Admin Label', 'extra' ),
				'type'        => 'text',
	...
	function get_fields() {
		$fields = array(
			'ad_internal_name' => array(
				'label'       => __( 'Admin Label', 'extra' ),
				'type'        => 'input',
				'description' => __( 'Name displayed internally in builder for this ad', 'extra' ),
			),
			'img_url'          => array(
				'label'              => __( 'Image URL', 'extra' ),
				'type'               => 'upload',
				'upload_button_text' => __( 'Upload an Image', 'extra' ),
				'choose_text'        => __( 'Choose an Image', 'extra' ),
				'update_text'        => __( 'Set as Image', 'extra' ),
				'description'        => __( 'URL of the ad image.', 'extra' ),
				'option_category'    => 'basic_option',
			),
			'link_url'         => array(
				'label'           => __( 'Link URL', 'extra' ),
				'type'            => 'input',
				'description'     => __( 'URL the ad\'s image links to.', 'extra' ),
				'option_category' => 'basic_option',
			),
			'new_line'         => array(
				'label'           => __( 'Start on New Line?', 'extra' ),
				'type'            => 'yes_no_button',
				'options'         => array(
					'off' => __( 'No', 'extra' ),
					'on'  => __( 'Yes', 'extra' ),
				),
				'description'     => __( 'Start the ad\'s output on a new line?', 'extra' ),
				'option_category' => 'configuration',
			),
			'content_new'      => array(
				'label'              => __( 'Ad HTML', 'extra' ),
				'type'               => 'tiny_mce',
				'tiny_mce_html_mode' => true,
				'description'        => __( 'The Ad HTML, if not using the Image URL and Link above.', 'extra' ),
				'option_category'    => 'basic_option',
			),
		);
