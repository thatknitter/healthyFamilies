...
define( 'ET_BUILDER_PREDEFINED_LAYOUTS_VERSION', 1 );

function et_pb_update_predefined_layouts() {
	// don't do anything if layouts version have been updated
	$layouts_version = 2;
	if ( 'on' === get_theme_mod( 'et_pb_predefined_layouts_version_' . ET_BUILDER_PREDEFINED_LAYOUTS_VERSION ) ) {
		return;
	}
