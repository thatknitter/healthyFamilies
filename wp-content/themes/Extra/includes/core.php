...
function extra_setup_theme() {
	...
	require_once $template_directory . '/epanel/post_thumbnails_extra.php';
	...
	register_nav_menus( array(
		'primary-menu'   => __( 'Primary Menu', 'extra' ),
		'secondary-menu' => __( 'Secondary Menu', 'extra' ),
		'footer-menu'    => __( 'Footer Menu', 'extra' ),
	) );
...
add_action( 'after_setup_theme', 'extra_setup_theme' );
...
function extra_register_post_types() {
	$labels = array(
		'name'               => _x( 'Category Layouts', 'layout type general name', 'extra' ),
		'singular_name'      => _x( 'Category Layout', 'layout type singular name', 'extra' ),
		'add_new'            => _x( 'Add New', 'layout item', 'extra' ),
		'add_new_item'       => __( 'Add New Category Layout', 'extra' ),
		'edit_item'          => __( 'Edit Category Layout', 'extra' ),
		'new_item'           => __( 'New Category Layout', 'extra' ),
		'all_items'          => __( 'All Category Layouts', 'extra' ),
		'view_item'          => __( 'View Category Layout', 'extra' ),
...
if ( ! function_exists( 'et_extra_fonts_url' ) ) :
	...
	function et_extra_fonts_url() {
         ...
         */
		$open_sans = _x( 'on', 'Open Sans font: on or off', 'extra' );
...
function extra_load_scripts_styles(){
	...
	wp_localize_script( 'extra-scripts', 'EXTRA', array(
		...
		'your_rating'                  => __( 'Your Rating:', 'extra' ),
		...
		'error'                        => __( 'There was a problem, please try again.', 'extra' ),
		'contact_error_name_required'  => __( 'Name field cannot be empty.', 'extra' ),
		'contact_error_email_required' => __( 'Email field cannot be empty.', 'extra' ),
		'contact_error_email_invalid'  => __( 'Please enter a valid email address.', 'extra' ),
	) );
...
function extra_register_sidebars() {
	...
	$sidebars = array(
		array(
			'name' => __( 'Main Sidebar', 'extra' ),
		),
		array(
			'name' => __( 'Project Sidebar', 'extra' ),
		),
	);
...
function extra_get_social_networks() {
	return apply_filters('extra_social_networks', array(
		'facebook'    => __( 'Facebook', 'extra' ),
		'twitter'     => __( 'Twitter', 'extra' ),
		'googleplus'  => __( 'Google+', 'extra' ),
		'pinterest'   => __( 'Pinterest', 'extra' ),
		'tumblr'      => __( 'Tumblr', 'extra' ),
		'stumbleupon' => __( 'Stumbleupon', 'extra' ),
		'wordpress'   => __( 'WordPress', 'extra' ),
		'instagram'   => __( 'Instagram', 'extra' ),
		'dribbble'    => __( 'Dribbble', 'extra' ),
		'vimeo'       => __( 'Vimeo', 'extra' ),
		'linkedin'    => __( 'LinkedIn', 'extra' ),
		'rss'         => __( 'RSS', 'extra' ),
		'deviantart'  => __( 'Deviantart', 'extra' ),
		'myspace'     => __( 'MySpace', 'extra' ),
		'skype'       => __( 'Skype', 'extra' ),
		'youtube'     => __( 'Youtube', 'extra' ),
		'picassa'     => __( 'Picassa', 'extra' ),
		'flickr'      => __( 'Flickr', 'extra' ),
		'blogger'     => __( 'Blogger', 'extra' ),
		'spotify'     => __( 'Spotify', 'extra' ),
		'delicious'   => __( 'Delicious', 'extra' ),
	));
}
...
function extra_enqueue_epanel_css() {
	wp_enqueue_style( 'et-edition-epanel-additional-css', get_template_directory_uri() . '/epanel/css/edition-panel.css' );
}

add_action( 'et_epanel_css_admin_enqueue', 'extra_enqueue_epanel_css' );
...
function extra_add_customizer_admin_menu() {
	...
	if ( et_pb_is_allowed( 'theme_customizer' ) ) {
		$wp_admin_bar->add_menu( array(
			...
			'title'  => __( 'Theme Customizer', 'extra' ),
	...
	if ( et_pb_is_allowed( 'module_customizer' ) ) {
		$wp_admin_bar->add_menu( array(
			...
			'title'  => __( 'Module Customizer', 'extra' ),
