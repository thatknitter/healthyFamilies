...
$options = array(
	...
	array(
		"name" => __( "Global Accent Color", $themename ),
		"type" => "textcolorpopup",
		"id"   => "accent_color",
	...
	array(
		...
		"type"           => "select",
		"options"        => array(
			( HOUR_IN_SECONDS )      => __( 'Every Hour', $themename ),
			( HOUR_IN_SECONDS * 3 )  => __( 'Every 3 Hours', $themename ),
			( HOUR_IN_SECONDS * 12 ) => __( 'Every 12 Hours', $themename ),
			( HOUR_IN_SECONDS * 24 ) => __( 'Every 1 Day', $themename ),
			( DAY_IN_SECONDS * 3 )   => __( 'Every 3 Days', $themename ),
			( DAY_IN_SECONDS * 7 )   => __( 'Every 7 Days', $themename ),
		),
	...
	array(
		...
		"options" => array(
			"standard" => __( 'Standard', $themename ),
			"masonry"  => __( 'Masonry', $themename ),
		),
	),
