	...
	<div class="container">
		<div id="content-area" class="<?php extra_sidebar_class(); ?> clearfix">
			...
			if ( have_posts() ) :
				...
				<div class="posts-blog-feed-module <?php echo esc_attr( $blog_feed_page_options['display_style'] ); ?> module" <?php echo 'masonry' == $blog_feed_page_options['display_style'] ? 'data-columns' : ''; ?> style="<?php echo esc_attr( $blog_feed_page_options['border_color_style'] ); ?>">
					<?php
