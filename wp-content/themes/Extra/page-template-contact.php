					...
					<div class="contact-content">
						...
						<form class="contact-form extra-contact-form" method="post">
							...
							<div class="field last">
								<input id="contact_subject" name="contact__subject" type="text" placeholder="<?php esc_attr_e( 'Subject', 'extra' ); ?>" />
							</div>

							<textarea id="contact_message" name="contact_message" placeholder="<?php esc_attr_e( 'Message', 'extra' ); ?>"></textarea>

							<button type="submit" class="submit"><?php esc_html_e( 'Send', 'extra' ); ?><span class="loader"><?php extra_ajax_loader_img(); ?></span></button>
