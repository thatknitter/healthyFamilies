						...
						<?php $user_color = !empty( $author->user_color ) ? $author->user_color : extra_global_accent_color(); ?>
							<div class="author" style="border-top-color:<?php echo esc_attr( $user_color ); ?>">
								...
								<div class="author-content">
									...
									<a href="<?php echo esc_url( get_author_posts_url( $author->ID ) ); ?>" class="button post-count" title="<?php esc_attr_e( sprintf( __( 'Posts By: %s', 'extra' ), $author->user_nicename ) ); ?>" rel="author"><?php esc_html_e( sprintf( _n( '%d Post', '%d Posts', $count ), $count ) ); ?></a>
								</div> <!-- /.author-content -->
