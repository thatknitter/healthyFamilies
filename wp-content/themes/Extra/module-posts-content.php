	...
	<div class="main-post">
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<div class="post-content">
				...
				<h2><a class="et-accent-color" style="color:<?php echo esc_attr( $color ); ?>;" href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h2>
				<div class="post-meta">
					<p><?php
	...
	?>
		<li>
			<article id="post-<?php the_ID(); ?>" <?php post_class( 'title-thumb-hover' ); ?>>
				...
				?>
				<div class="post-content">
					<h3><a href="<?php the_permalink(); ?>" data-hover-color="<?php echo esc_attr( $color ); ?>"><?php the_title(); ?></a></h3>
					<div class="post-meta">
						<p><?php
						echo et_extra_display_post_meta(array(
							'author_link'   => $show_author,
