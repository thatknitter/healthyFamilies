					...
					while ( have_posts() ) : the_post(); ?>
						<article id="post-<?php the_ID(); ?>" <?php post_class( 'module single-project-module' ); ?>>
							...
							<div class="post-thumbnail post-gallery">
								<div class="gallery et-slider" data-autoplay="<?php echo $gallery_autoplay ? esc_attr( $gallery_autoplay ) : ''; ?>">
				...
				<nav class="post-nav">
					<div class="nav-links clearfix">
						<div class="nav-link nav-link-prev">
							<?php previous_post_link( '%link', __( '<span class="button" title="%title"></span>', 'extra' ) ); ?>
						</div>
						<div class="nav-link nav-link-next">
							<?php next_post_link( '%link', __( '<span class="button" title="%title"></span>', 'extra' ) ); ?>
						</div>
					</div>
				</nav>
