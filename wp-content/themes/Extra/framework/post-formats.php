...
function et_register_post_format_taxonomy(){
	...
	register_taxonomy( ET_POST_FORMAT, 'post', array(
		...
		'hierarchical'      => false,
		'labels'            => array(
			'name'          => _x( 'Format', $shortname ),
			'singular_name' => _x( 'Format', $shortname ),
		),
		'query_var'         => true,
		'rewrite'           => false,
		'show_ui'           => false,
...
function et_get_post_format_strings() {
	$strings = array(
		'standard' => __( 'Standard', 'extra' ), // Special case. any value that evals to false will be considered standard
		'aside'    => __( 'Aside', 'extra' ),
		'chat'     => __( 'Chat', 'extra' ),
		'gallery'  => __( 'Gallery', 'extra' ),
		'link'     => __( 'Link', 'extra' ),
		'image'    => __( 'Image', 'extra' ),
		'quote'    => __( 'Quote', 'extra' ),
		'status'   => __( 'Status', 'extra' ),
		'video'    => __( 'Video', 'extra' ),
		'audio'    => __( 'Audio', 'extra' ),
		'map'      => __( 'Map', 'extra' ),
	);
