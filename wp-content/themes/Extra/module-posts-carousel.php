...
?>
<div class="module posts-carousel-module et_pb_extra_module loading <?php echo esc_attr( $module_class ); ?>" style="border-top-color:<?php echo esc_attr( $border_top_color ); ?>" data-autoplay="<?php echo $enable_autoplay ? esc_attr( $autoplay_speed ) : ''; ?>">
